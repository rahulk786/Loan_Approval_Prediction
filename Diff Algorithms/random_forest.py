...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 28 11:35:59 2020
...
X = df.iloc[:, [1,2,3,6,8,9,10,11]].values
y = df.iloc[:,7].values
X_train, X_test, y_train, y_test = train_test_split(X, y, random_state=0,test_size=0.25)

#Applying feature scaling to CPL_Amount,CPL_Term,Total_Income
...
classifier = RandomForestClassifier(n_estimators = 100,max_depth=30,min_samples_split=20, criterion = 'entropy', random_state = 0)
