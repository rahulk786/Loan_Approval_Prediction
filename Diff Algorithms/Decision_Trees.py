...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 28 09:33:12 2020
...
X = df.loc[:, df.columns != 'CPL_Status'].values
y = df.iloc[:,7].values
...
classifier = DecisionTreeClassifier(criterion = 'entropy', max_depth=40,min_samples_split=40,random_state = 0)
